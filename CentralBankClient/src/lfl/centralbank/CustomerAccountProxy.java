 ...
 * @author Luisito
 */
public class CustomerAccountProxy implements InvocationHandler{

    Object obj;

    public CustomerAccountProxy(Object o){
        obj = o;
    ...
    public Object invoke(Object proxy, Method m, Object[] args) throws Throwable {
        ...
        try {
            ...
            System.out.println("I'm here in the CustomerAccountProxy invoke...");
            ...
            result = m.invoke((CustomerAccountImpl)obj);
