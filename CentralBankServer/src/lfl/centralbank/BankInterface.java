...
public interface BankInterface {
    ...
    boolean closeAccount(CustomerAccount customerAccount);

    //double getAccountBalance();
    
    //double getAccountBalance(String customerName, String accountNumber);

    double getAccountBalance(CustomerAccount customerAccount);
    ...
    boolean makeDeposit(CustomerAccount customerAccount, double depositAmount);

    boolean openAccount(CustomerAccount customerAccount);
